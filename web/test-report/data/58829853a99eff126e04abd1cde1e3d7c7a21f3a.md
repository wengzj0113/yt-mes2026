...
- Name: comprehensive-e2e.spec.ts >> Group 1: Auth & Layout >> TC-LOGIN-004: Password visibility toggle
- Location: tests\comprehensive-e2e.spec.ts:33:3
...
Call log:
  - waiting for locator('.el-input__password-icon, .el-input__icon.eye-icon')
...
- generic [ref=e4]:
  ...
  - generic [ref=e7]:
    ...
    - generic [ref=e20]:
      - img [ref=e23]
      - textbox "密码" [active] [ref=e26]: test123
