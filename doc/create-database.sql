...
BEGIN
    CREATE TABLE sorting_record (
        ...
        is_draft            BIT             NOT NULL DEFAULT 1,
        equipment_code      NVARCHAR(16)    NOT NULL,
        ocv_voltage_range   NVARCHAR(500)   NULL,
        ocv_voltage_min     DECIMAL(10,4)   NULL,
        ocv_voltage_max     DECIMAL(10,4)   NULL,
        ir_range            NVARCHAR(500)   NULL,
        ir_min              DECIMAL(10,4)   NULL,
        ir_max              DECIMAL(10,4)   NULL,
        capacity_range      NVARCHAR(500)   NULL,
        capacity_min        DECIMAL(10,4)   NULL,
        capacity_max        DECIMAL(10,4)   NULL,
        operator_name       NVARCHAR(32)    NOT NULL,
        created_by          INT             NOT NULL,
        created_at          DATETIME2       NOT NULL DEFAULT GETDATE(),
        updated_by          INT             NULL,
